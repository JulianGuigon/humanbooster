...
<div class="container">
	...
	<form:form method="post" action="${url}" modelAttribute="user">
		...
		<form:label path="email">
			<a style="color: red;">*</a>Email : </form:label>
		<form:input path="email" cssClass="form-control" type="email"
			style="${errorClass}" />
		<form:errors path="email" cssStyle="color:red;" />
		<br>
		<form:label path="password">
			<a style="color: red;">*</a>Password : </form:label>
		...
		<form:input path="address.wording" cssClass="form-control" type="text"
			style="${errorClass}" />
		<form:errors path="address.wording" cssStyle="color:red;" />
		<br>
		<form:label path="address.streetNumber">Street number : </form:label>
		<form:input path="address.streetNumber" cssClass="form-control"
			type="number" style="${errorClass}" />
		<form:errors path="address.streetNumber" cssStyle="color:red;" />
		<br>
		<form:label path="address.country">Country : </form:label>
		<form:input path="address.country" cssClass="form-control" type="text"
			style="${errorClass}" />
		<form:errors path="address.country" cssStyle="color:red;" />
		<br>
		<form:label path="address.city">City : </form:label>
		<form:input path="address.city" cssClass="form-control" type="text"
			style="${errorClass}" />
		<form:errors path="address.city" cssStyle="color:red;" />
		<br>
		<form:label path="address.postalCode">Postal Code : </form:label>
		<form:input path="address.postalCode" cssClass="form-control"
			type="number" style="${errorClass}" />
		<form:errors path="address.postalCode" cssStyle="color:red;" />
		<br>
