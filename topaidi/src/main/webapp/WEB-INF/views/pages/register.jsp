...
<div class="container">
	...
	<form:form method="post" action="${url}" modelAttribute="user">
		...
		<spring:hasBindErrors name="disk">
		...
		<br><label><a style="color: red;">*</a>Repeat password : </label>
		...
		<form:input path="address.streetNumber" cssClass="form-control" type="text" style="${errorClass}"/>
		...
		<form:input path="address.postalCode" cssClass="form-control" type="text" style="${errorClass}"/>
		<form:errors path="phoneNumber" cssStyle="color:red;"/><br>
		<form:label path="phoneNumber">Phone : </form:label>
		<form:input path="phoneNumber" cssClass="form-control" type="text" style="${errorClass}"/>
		<br>
