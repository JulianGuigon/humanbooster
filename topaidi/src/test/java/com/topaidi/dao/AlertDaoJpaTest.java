...
public class AlertDaoJpaTest {
	...
	public void testDeleteWithComment() {
		...
		User user3 = new User("Jean Guy","a.g@gmail.com","aaaa",address4,"0477265898",true,true);
	...
	public void testFindAll() {
		...
		User user7 = new User("Jean Guy","a.g@gmail.com","aaaa",address10,"0477265898",true,true);
		User user8 = new User("Jean Robert","a.g@gmail.com","aaaa",address11,"0477265898",true,true);
		User user9 = new User("Jean Bernard","a.g@gmail.com","aaaa",address12,"0477265898",true,true);
		...
		Admin admin4 = new Admin("Jean Guy","a.g@gmail.com","aaaa",address13,"0477265898");
		Admin admin5 = new Admin("Jean Robert","a.g@gmail.com","aaaa",address14,"0477265898");
		Admin admin6 = new Admin("Jean Bernard","a.g@gmail.com","aaaa",address15,"0477265898");
		...
		User user10 = new User("Jean Guy","a.g@gmail.com","aaaa",address16,"0477265898",true,true);
		User user11 = new User("Jean Robert","a.g@gmail.com","aaaa",address17,"0477265898",true,true);
		User user12 = new User("Jean Bernard","a.g@gmail.com","aaaa",address18,"0477265898",true,true);
	...
	public void testFindAllByCreateAt() {
		...
		ideaDao.insert(idea5);
		ideaDao.insert(idea6);
		Alert alert4 = new Alert("Alert4",LocalDate.of(2015, 04, 10),AlertType.Comment,idea4,user10);
		Alert alert5 = new Alert("Alert5",LocalDate.of(2015, 05, 10),AlertType.Comment,idea5,user11);
		Alert alert6 = new Alert("Alert6",LocalDate.of(2015, 06, 10),AlertType.Comment,idea6,user12);
		alertDao.insert(alert4);
		alertDao.insert(alert5);
		alertDao.insert(alert6);
		
		assertTrue(alertDao.findAllByCreateAt().get(5).getMessage().equals("Alert1"));
	}
	...
	public void testFindAllByCreateAtAndByType() {
		...
		ideaDao.insert(idea5);
		ideaDao.insert(idea6);
		Alert alert4 = new Alert("Alert4",LocalDate.of(2015, 04, 10),AlertType.Idea,idea4,user10);
		Alert alert5 = new Alert("Alert5",LocalDate.of(2015, 05, 10),AlertType.Idea,idea5,user11);
		Alert alert6 = new Alert("Alert6",LocalDate.of(2015, 06, 10),AlertType.Idea,idea6,user12);
		alertDao.insert(alert4);
		alertDao.insert(alert5);
		alertDao.insert(alert6);
		
		assertTrue(alertDao.findAllByCreateAtAndByType(AlertType.Comment).get(0).getMessage().equals("Alert3"));
	}
