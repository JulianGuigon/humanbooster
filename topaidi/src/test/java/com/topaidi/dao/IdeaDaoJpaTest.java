...
public class IdeaDaoJpaTest {
	...
	public void testFindAllError() {
		assertTrue(ideaDao.findAll().size()==0);
	}
	...
	public void findAllByCreateAt() {
		...
		Assert.assertTrue(ideaDao.findAllByCreateAt().get(2).getTitle().equals("idea1"));
	}
	...
	public void findAllWithUser() {
		...
		Assert.assertTrue(ideaDao.findAllWithUser(user1).size()==1);
	}
